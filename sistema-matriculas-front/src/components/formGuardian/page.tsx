        ...
        onSubmit={async values =>{
          console.log(values);
            ...
            const data ={
                ...
                studentAddress: buildAddress(values.studentState, values.studentCity, values.studentNeighborhood, values.studentRoad, values.studentHouseNumber, values.studentCep),
                ...
                motherAddress: buildAddress(values.motherState, values.motherCity, values.motherNeighborhood, values.motherRoad, values.motherHouseNumber, values.motherCep),
                ...
                fatherAddress: buildAddress(values.fatherState, values.fatherCity, values.fatherNeighborhood, values.fatherRoad, values.fatherHouseNumber, values.fatherCep),
                status: "RESERVED",
            }
            ...
            >
              ...
              <div>
                <label className="block text-gray-700 font-medium mb-1">
                  Nome do aluno (a) <span className="text-red-500">*</span>
                </label>
                <Field
                  type="text"
              ...
              <div>
                <label className="block text-gray-700 font-medium mb-1">
                  CEP do estudante <span className="text-red-500">*</span>
                </label>
                <Field
                  type="text"
                  name="studentCep"
              ...
              <div>
                <label className="text-gray-700 font-medium mb-1">
                  CPF da mãe <span className="text-red-500">*</span>
                </label>
                <Field
                  type="text"
                  name="motherCpf"
              ...
              <div>
                <label className="text-gray-700 font-medium mb-1">
                  CEP da mãe <span className="text-red-500">*</span>
                </label>
                <Field
                  type="text"
                  name="motherCep"
              ...
              <div>
                <label className="text-gray-700 font-medium mb-1">
                  Nome completo do pai <span className="text-red-500">*</span>
                </label>
                <Field
                  type="text"
                  name="fullFatherName"
              ...
              <div>
                <label className="text-gray-700 font-medium mb-1">
                  CPF do pai <span className="text-red-500">*</span>
                </label>
                <Field
                  type="text"
                  name="fatherCpf"
              ...
              <div>
                <label className="text-gray-700 font-medium mb-1">
                  CEP do pai <span className="text-red-500">*</span>
                </label>
                <Field
                  type="text"
                  name="fatherCep"
              ...
              <button type="submit" className="bg-[#FFA12B] text-white px-8 py-4 rounded-md w-full sm:w-auto font-montserrat font-medium text-[18px] sm:text-[20px] lg:text-[22px] transition-all duration-200`">Enviar</button>
            </Form>
          </div>
        )}
      </Formik>
